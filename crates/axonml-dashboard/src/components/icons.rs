...
#[component]
pub fn IconGrid(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/>"#.to_string() size=size class=class /> }
}

#[component]
pub fn IconGlobe(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<circle cx="12" cy="12" r="10"/><line x1="2" x2="22" y1="12" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>"#.to_string() size=size class=class /> }
}

#[component]
pub fn IconImage(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>"#.to_string() size=size class=class /> }
}

#[component]
pub fn IconFileText(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" x2="8" y1="13" y2="13"/><line x1="16" x2="8" y1="17" y2="17"/><line x1="10" x2="8" y1="9" y2="9"/>"#.to_string() size=size class=class /> }
}

#[component]
pub fn IconVolume(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/>"#.to_string() size=size class=class /> }
}

#[component]
pub fn IconFolder(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>"#.to_string() size=size class=class /> }
}

#[component]
pub fn IconStar(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>"#.to_string() size=size class=class /> }
}

#[component]
pub fn IconAlert(#[prop(default = IconSize::Md)] size: IconSize, #[prop(optional, into)] class: String) -> impl IntoView {
    view! { <IconBase path=r#"<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/>"#.to_string() size=size class=class /> }
}
