...
fn main() {
    ...
    println!("Loading iris identities from {}...", config.data_dir.display());
    ...
    println!(
        ...
        start_epoch + 1, config.epochs, config.batch_size, triplets_per_epoch, config.batches_per_epoch
    );
    ...
    for epoch in start_epoch..config.epochs {
        ...
        for _ in 0..config.batches_per_epoch {
            ...
            let mut anchor_t = Tensor::from_vec(anchor_data, &[config.batch_size, 1, 32, 256]).unwrap();
